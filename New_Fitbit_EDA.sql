...
-- Daily Minutes by Intensity Type (Longitudinal) √
...
-- Intensity by Weekdays (Longitudinal) √
...
-- Activity Trends by Weekday and Time	
	
SELECT
	Id,
	CASE
		WHEN DAYOFWEEK(STR_TO_DATE(RTRIM(SUBSTRING(ActivityHour, 1, 9)), '%m/%d/%Y')) = 1 THEN "Sunday"
		WHEN DAYOFWEEK(STR_TO_DATE(RTRIM(SUBSTRING(ActivityHour, 1, 9)), '%m/%d/%Y')) = 2 THEN "Monday"
		WHEN DAYOFWEEK(STR_TO_DATE(RTRIM(SUBSTRING(ActivityHour, 1, 9)), '%m/%d/%Y')) = 3 THEN "Tuesday"
		WHEN DAYOFWEEK(STR_TO_DATE(RTRIM(SUBSTRING(ActivityHour, 1, 9)), '%m/%d/%Y')) = 4 THEN "Wednesday"
		WHEN DAYOFWEEK(STR_TO_DATE(RTRIM(SUBSTRING(ActivityHour, 1, 9)), '%m/%d/%Y')) = 5 THEN "Thursday"
		WHEN DAYOFWEEK(STR_TO_DATE(RTRIM(SUBSTRING(ActivityHour, 1, 9)), '%m/%d/%Y')) = 6 THEN "Friday"
		ELSE "Saturday"
	END AS DayoftheWeek,
	CASE 
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '12:%AM' THEN "12:00:00 AM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '1:%AM' THEN "1:00:00 AM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '2:%AM' THEN "2:00:00 AM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '3:%AM' THEN "3:00:00 AM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '4:%AM' THEN "4:00:00 AM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '5:%AM' THEN "5:00:00 AM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '6:%AM' THEN "6:00:00 AM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '7:%AM' THEN "7:00:00 AM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '8:%AM' THEN "8:00:00 AM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '9:%AM' THEN "9:00:00 AM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '10:%AM' THEN "10:00:00 AM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '11:%AM' THEN "11:00:00 AM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '12:%PM' THEN "12:00:00 PM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '1:%PM' THEN "1:00:00 PM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '2:%PM' THEN "2:00:00 PM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '3:%PM' THEN "3:00:00 PM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '4:%PM' THEN "4:00:00 PM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '5:%PM' THEN "5:00:00 PM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '6:%PM' THEN "6:00:00 PM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '7:%PM' THEN "7:00:00 PM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '8:%PM' THEN "8:00:00 PM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '9:%PM' THEN "9:00:00 PM"
		WHEN LTRIM(SUBSTRING(ActivityHour, 10, 21)) LIKE '10:%PM' THEN "10:00:00 PM"
		ELSE "11:00:00 PM"
	END AS TimeofDay,
	AVG(TotalIntensity) AS AverageIntensity
FROM 
	Bellabeat.HourlyIntensities
GROUP BY
	Id,
	DayoftheWeek,
	TimeofDay
...
-- Weekly Sleep Trends (Longitudinal) √

SELECT
	DayoftheWeek, "AverageMinutesinBed" AS SleepMetric, AverageTimeinBed AS AverageMinutes
FROM
	Bellabeat.NewWeeklyTrends
UNION ALL
SELECT
	DayoftheWeek, "AverageMinutesAsleep" AS SleepMetric, AverageMinutesAsleep AS AverageMinutes
FROM
	Bellabeat.NewWeeklyTrends
UNION ALL
SELECT
	DayoftheWeek, "AverageMinutestoSleep" AS SleepMetric, AverageTimetoSleep AS AverageMinutes
FROM
	Bellabeat.NewWeeklyTrends
...
-- Standardized Weekly Trends (Longitudinal) √

SELECT
	DayoftheWeek, "Steps Z-Score" AS Metric, StepsZScore AS ZScore
FROM 
	Bellabeat.WeeklyStandardized
UNION ALL
SELECT
	DayoftheWeek, "Calories Z-Score" AS Metric, CaloriesZScore AS ZScore
FROM 
	Bellabeat.WeeklyStandardized
UNION ALL
SELECT
	DayoftheWeek, "METs Z-Score" AS Metric, METsZScore AS ZScore
FROM 
	Bellabeat.WeeklyStandardized
UNION ALL
SELECT
	DayoftheWeek, "Minutes in Bed Z-Score" AS Metric, TimeinBedZScore AS ZScore
FROM 
	Bellabeat.WeeklyStandardized
UNION ALL
SELECT
	DayoftheWeek, "Minutes to Sleep Z-Score" AS Metric, TimetoSleepZScore AS ZScore
FROM 
	Bellabeat.WeeklyStandardized
UNION ALL
SELECT
	DayoftheWeek, "Minutes Asleep Z-Score" AS Metric, MinutesAsleepZScore AS ZScore
FROM 
	Bellabeat.WeeklyStandardized
